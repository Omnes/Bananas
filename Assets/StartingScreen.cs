...
public class StartingScreen : MenuBase 
{
	...
	public override void InitMenuItems()
	{
		...
		AdjustMenuItem (m_menuItems [0], new LTRect (-200, 100.0f, size.x, size.y), new Vector2 (centerX, screenHeight-(size.y * 2)),
		                new Rect(0.565f, 0.19f, 0.43f, 0.165f) , LeanTweenType.easeOutElastic);
